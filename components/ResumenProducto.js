...
const ResumenProducto = ({producto}) =>  {
  ...
  <div className='md:w-4/6'>
      ...
      <p className='text-xl font-bold text-purple-600 mt-2'>Precio: {formatearDinero(producto.precio)}</p>

      <p className='text-xl mt-1'>Subtotal: {formatearDinero(producto.precio * producto.cantidad)}</p>
  </div>
